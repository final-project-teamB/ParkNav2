...
public class MgtController {
    ...
    @PostMapping("/enter")
    public ApiResponseDto<CarInResponseDto> enter(@Valid @RequestBody CarNumRequestDto requestDto) {
        return mgtService.enter(requestDto);
    }

    @PutMapping("/exit")
    public ApiResponseDto<CarOutResponseDto> exit(@Valid @RequestBody CarNumRequestDto requestDto) {
